...
const PRESETS: { key: Preset; label: string; hint: string }[] = [
  ...
  { key: "SQUARE_1_1",    label: "Feed 1:1",            hint: "1080×1080" },
  { key: "PORTRAIT_4_5",  label: "Feed 4:5",            hint: "1080×1350" },
  { key: "LANDSCAPE_16_9",label: "YouTube/Landscape",   hint: "1920×1080" },
];
...
export default function Studio() {
  ...
  function gerarCopy() {
    setCopy([
      `Atenção: publique no formato ${presetInfo.label} (${presetInfo.hint}).`,
